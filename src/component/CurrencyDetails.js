  ...
  return (
    <div className="details">
      ...
      <ul className="detailsList">
        ...
        <li>
          <span>{currency.eur}</span> <span className="curName">euros</span>
          <img className="right-details" src={right} alt="right-arrow" />
        </li>
        <li>
          <span>{currency.btc}</span> <span className="curName">bitcoin</span>
          <img className="right-details" src={right} alt="right-arrow" />
        </li>
        <li>
        ...
        <li>
          <span>{currency.thb}</span> <span className="curName">Thai baht</span>
          <img className="right-details" src={right} alt="right-arrow" />
        </li>
        <li>
